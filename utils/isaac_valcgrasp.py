...
class ContactGraspingValidator():
    """
    Initialize ContactGrasping Env

    args:
        mode: str, default='direct'
        hand_friction: float, default=3.
        obj_friction: float, default=3.
        threshold_dis: float, default=0.1
        env_batch: int, default=1
        sim_step: int, default=100
        gpu: int, default=0
        debug_interval: float, default=0.05
        joint_names: list, default=None
    """
    ...
    def __init__(self,
        ...
        self.num_hand_dofs = 16     # maybe 22 or 28 for shadow
        if joint_names is None:
            self.joint_names = ['1','0','2','3','5','4','6','7','9','8','10','11','12','13','14','15']
        else:
            self.joint_names = joint_names  # probably has joint_names like 'FFJ4'
    ...
    def run_sim(self):
        """
        1、物理仿真循环
        2、接触检测：如果接触发生在手和物体之间，记录success
        """
